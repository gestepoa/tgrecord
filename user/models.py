...
class Ideology(db.Model):
    ...
    nation_view = db.Column(db.Enum('汉族主义', '完整公民权', '有限公民权', '中华民族叙事'), unique=False, nullable=True, comment="民族观点")
    war_view = db.Column(db.Enum('沙文主义', '和平主义', '解放台湾'), unique=False, nullable=True, comment="战争观点")
